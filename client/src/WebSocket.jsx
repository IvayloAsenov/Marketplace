...
class WebSocketService{
    ...
    fetchMessages(chatroom_id){
        console.log("M " + this.sendMessage({command : 'fetch_messages', chatroom : chatroom_id}));
    }

    newChatMessage(message){
        this.sendMessage({command : 'new_message', from : message.from, text : message.text, chatroom: message.chatroom});
    }
