...
class UpdateListingModel extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            amount: 1,
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea name="description" className="form-control" placeholder="Describe your amazing piece of clothing!"
                                      rows="4" cols="50" onChange={this.handleChange} value={this.state.description}  required />
                        </div>
                        <div className="form-row">
...
export default UpdateListingModel;